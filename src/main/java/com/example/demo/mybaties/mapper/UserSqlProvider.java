...
import com.example.demo.mybaties.model.UserExample.Criteria;
import com.example.demo.mybaties.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getSysTem() != null) {
            VALUES("sys_tem", "#{sysTem,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSysTem() != null) {
            SET("sys_tem = #{record.sysTem,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getSysTem() != null) {
            SET("sys_tem = #{sysTem,jdbcType=INTEGER}");
        }
